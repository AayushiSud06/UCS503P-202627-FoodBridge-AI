...
import { LayoutDashboard, Truck, History, BarChart2, User, Menu, X, Leaf } from 'lucide-react';
...
const NAV_ITEMS = [
  ...
  { label: 'Pickup Tasks',  path: '/volunteer/tasks',    icon: Truck },
  { label: 'History',       path: '/volunteer/history',  icon: History },
  { label: 'Impact',        path: '/volunteer/impact',   icon: BarChart2 },
